...
class UsuariosService
{
    ...
    public function validarGet()
    {
        ...
        if(in_array($recurso, self::RECURSOS_GET, true)){
            $retorno = $this->dados['id'] > 0 ? $this->getOneByKey() : $this->$recurso(); //metodo variavel $this->listar()
        }else{
    ...
    public function validarDelete()
    {
        ...
        if(in_array($recurso, self::RECURSOS_DELETE, true)){
            if($this->dados['id'] > 0){
                $retorno = $this->$recurso(); //metodo variavel $this->deletar()
            }else{
    ...
    public function validarPost()
    {
        ...
        if(in_array($recurso, self::RECURSOS_POST, true)){
            $retorno = $this->$recurso(); //metodo variavel $this->cadastrar()
        }else{
            throw new \InvalidArgumentException(ConstantesGenericasUtil::MSG_ERRO_RECURSO_INEXISTENTE);
        }
    ...
    public function validarPut()
    {
        ...
        if(in_array($recurso, self::RECURSOS_PUT, true)){
            if($this->dados['id'] > 0){
                $retorno = $this->$recurso(); //metodo variavel $this->atualizar()
            }else{
                throw new \InvalidArgumentException(ConstantesGenericasUtil::MSG_ERRO_ID_OBRIGATORIO);
            }
        }else{
